...
let messages = [
    ...
    "I've probably listened to your 'Future Days' cover at least 100 times. It's beautiful. Better than the original. Goosebumps everytime. ",
    ...
    `<button class="btn btn-pulse"><a href='https://www.youtube.com/watch?v=c1VNAUqwREY' target="_blank" style="font-size:500%";>&#9835; </a></button><br><sup>(4)</sup>`,

    `<button class="btn btn-pulse"><a href='https://www.youtube.com/watch?v=nt3Ggo1CE3g' target="_blank" style="font-size:500%";>&#9835; </a></button><br><sup>(2)</sup>`,

    `<button class="btn btn-pulse"><a href='https://www.youtube.com/watch?v=K5KAc5CoCuk' target="_blank" style="font-size:500%";>&#9835; </a></button><br><sup>Could you sing this?<br>(Don't do it, I'm just curious)</sup>`,

    'You look really cute in pink.',
    ...
    "Our first hug is going to be wild.",
    ...
    "I should have been there for you all these years. I'm sorry that I wasn't. I know I wasn't ready for you before and I had growing to do but, well that's good for me I guess but what about you. The thought of you alone, hurt and mistreated. it breaks my heart.<br><br>edit: I wrote this literally the night before you showed me the song you wrote for me. It's your best one yet. I love you. I hope you never get tired of hearing it",
];
